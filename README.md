...
| Hilight       | Notes           |
| :------------- |:------------- | 
| **Demo Site**      | Endpoint hosting REST APIs that this repository delivers. The REST APIs execute live queries on an an Amazon Redshift cluster. [REST API Demo URL](http://athenaapi-env-1.eba-9wbzews5.ap-south-1.elasticbeanstalk.com/swagger-ui.html) (Current Status: **Shutdown**) | 
...
| **Technology Stack** | This repo uses a variety of technologies including **Amazon Redshift**, **S3**, **Elastic Beanstalk**, Java 11, Spring Data, Spring Boot, Swagger, Gradle, JUnit, Docker and Kubernetes. See [Technologies used by Athena](https://github.com/arunkpatra/athena/wiki/Technology-Stack)      |  
