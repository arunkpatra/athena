...
| **Technologies Used** | This repo uses a variety of technologies using Java, Spring Data, Gradle, JUnit, **Amazon Redshift** and **S3**. See [Technologies used by Athena](https://github.com/arunkpatra/athena/wiki/AWS-Technologies-Used)      |  
